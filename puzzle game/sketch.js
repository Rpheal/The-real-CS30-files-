...
let grid; const NUM_COLS = 5; const NUM_ROWS = 4; let rectWidth = 100; let rectHeight = 100;
let row; let col; let pattern = "cross";
...
function draw() {
  ...
  row = getCurrentY();
  draw_grid();
  if(Win()){ // check Condition for win and display win or not
...
function mousePressed(){ // handle mouse clicked event and flip pattern
